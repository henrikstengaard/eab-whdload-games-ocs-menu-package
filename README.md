# EAB WHDLoad Games OCS Menu Package

EAB WHDLoad Games OCS Menu package contains menus for AGS2 and iGame with screenshots and details for all OCS games currently available in Retroplay's WHDLoad packs at English Amiga Board. Menus, screenshots and details are generated using powershell scripts and data files from https://github.com/henrikstengaard/amiga-whdload-game-scripts.

Screenshots and details for all OCS games are based on Retroplay's WHDLoad packs downloaded December 4th 2021.
...
EAB WHDLoad Games OCS Menu package contains following features:

- Arcade Game Selector 2 v2020-04-14, https://github.com/MagerValp/ArcadeGameSelector.
- Arcade Game Selector 2 preconfigured menu with screenshots at resolution 320x128 and 12 colors and game details.
...
EAB WHDLoad Games OCS Menu package can be installed on any Amiga with Workbench 3.1 (or better) and about 128MB free space on a harddrive for installation.

For EAB WHDLoad Games OCS Menu package to work properly, it requires following applications and libraries are installed:
...
Installation of EAB WHDLoad Games OCS Menu package requires and uses following assign:
...
EAB WHDLoad Games OCS Menu package will automatically update SYSTEMDIR:S/Assign-Startup following assigns:
